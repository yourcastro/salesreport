...
exports.MultiColumnComboBox = React.forwardRef(function (props, ref) {
    ...
    var _b = props.columns, columns = _b === void 0 ? defaultProps.columns : _b, _c = props.popupSettings, popupSettings = _c === void 0 ? defaultProps.popupSettings : _c, onOpen = props.onOpen, onClose = props.onClose, onFocus = props.onFocus, onBlur = props.onBlur, onChange = props.onChange, onFilterChange = props.onFilterChange, onPageChange = props.onPageChange, other = __rest(props, ["columns", "popupSettings", "onOpen", "onClose", "onFocus", "onBlur", "onChange", "onFilterChange", "onPageChange"]);
    ...
    var scrollerRefFn = React.useCallback(function (scroller) {
        if (scroller) {
    ...
    React.useEffect(function () {
        if (scrollerRef.current) {
            setScrollbarWidth(scrollerRef.current.offsetWidth - scrollerRef.current.clientWidth);
        }
    }, [(props.data || []).length]);
    var List = React.useCallback(function (listProps) { return React.createElement(MultiColumnList_1.MultiColumnList, __assign({}, listProps, { wrapperRef: scrollerRefFn })); }, []);
    return (React.createElement(ComboBox_1.default, __assign({}, other, { list: List, popupSettings: __assign({ width: popupWidth }, popupSettings, { className: kendo_react_common_1.classNames('k-dropdowngrid-popup k-popup-flush', popupSettings.className) }), ref: comboBoxRef, header: header, itemRender: itemRender, onOpen: onOpenHandler, onClose: onCloseHandler, onFocus: onFocusHandler, onBlur: onBlurHandler, onChange: onChangeHandler, onFilterChange: onFilterChangeHandler, onPageChange: onPageChangeHandler })));
});
