...
var Slider = /** @class */ (function (_super) {
    ...
    function Slider(props) {
        ...
        _this.onKeyDown = function (e) {
            ...
            if (e.keyCode === kendo_react_common_1.Keys.left || e.keyCode === kendo_react_common_1.Keys.down) {
                newValue = _this.state.value - (_this.props.step || 0);
            }
            else if (e.keyCode === kendo_react_common_1.Keys.right || e.keyCode === kendo_react_common_1.Keys.up) {
                newValue = _this.state.value + (_this.props.step || 0);
            }
            else if (e.keyCode === kendo_react_common_1.Keys.home) {
                newValue = _this.props.min;
            }
            else if (e.keyCode === kendo_react_common_1.Keys.end) {
...
kendo_react_intl_1.registerForLocalization(Slider);
