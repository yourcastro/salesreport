 ...
 */
exports.RangeSlider = React.forwardRef(function (props, ref) {
    var _a, _b, _c, _d;
    ...
    var handleStartKeyDown = React.useCallback(function (event) {
        switch (event.keyCode) {
            case kendo_react_common_1.Keys.right:
                ...
                dispatchStateValue({ type: dir === 'rtl' ? range_raducer_1.RANGE_ACTION.decrease : range_raducer_1.RANGE_ACTION.increase, key: 'start', event: event });
                break;
            case kendo_react_common_1.Keys.up:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.increase, key: 'start', event: event });
                break;
            case kendo_react_common_1.Keys.left:
                event.preventDefault();
                dispatchStateValue({ type: dir === 'rtl' ? range_raducer_1.RANGE_ACTION.increase : range_raducer_1.RANGE_ACTION.decrease, key: 'start', event: event });
                break;
            case kendo_react_common_1.Keys.down:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.decrease, key: 'start', event: event });
                break;
            case kendo_react_common_1.Keys.home:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.min, key: 'start', event: event });
                break;
            case kendo_react_common_1.Keys.end:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.max, key: 'start', event: event });
                break;
            default:
                break;
        }
    ...
    var handleEndKeyDown = React.useCallback(function (event) {
        switch (event.keyCode) {
            case kendo_react_common_1.Keys.right:
                event.preventDefault();
                dispatchStateValue({ type: dir === 'rtl' ? range_raducer_1.RANGE_ACTION.decrease : range_raducer_1.RANGE_ACTION.increase, key: 'end', event: event });
                break;
            case kendo_react_common_1.Keys.up:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.increase, key: 'end', event: event });
                break;
            case kendo_react_common_1.Keys.left:
                event.preventDefault();
                dispatchStateValue({ type: dir === 'rtl' ? range_raducer_1.RANGE_ACTION.increase : range_raducer_1.RANGE_ACTION.decrease, key: 'end', event: event });
                break;
            case kendo_react_common_1.Keys.down:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.decrease, key: 'end', event: event });
                break;
            case kendo_react_common_1.Keys.home:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.min, key: 'end', event: event });
                break;
            case kendo_react_common_1.Keys.end:
                event.preventDefault();
                dispatchStateValue({ type: range_raducer_1.RANGE_ACTION.max, key: 'end', event: event });
                break;
            default:
                break;
        }
    ...
    var handleTrackDrag = function (event) {
        var payload = calcNewDistance(event);
        var action = currentDrag === 'end' ? range_raducer_1.RANGE_ACTION.end : range_raducer_1.RANGE_ACTION.start;
        dispatchStateValue({ type: action, payload: payload, event: event });
    };
...
exports.RangeSlider.displayName = 'KendoReactRangeSlider';
// TODO: delete casting when @types/react is updated!
exports.RangeSlider.propTypes = propTypes;
exports.RangeSlider.defaultProps = defaultProps;
