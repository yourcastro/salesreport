    ...
    GridColumnMenuCheckboxFilter.prototype.render = function () {
        ...
        var searchBox = this.props.searchBox ?
            ...
            (React.createElement("div", { className: "k-searchbox" },
                ...
                React.createElement("input", { className: "k-input", type: "text", placeholder: localizationService.toLanguageString(messages_1.searchPlaceholder, messages_1.messages[messages_1.searchPlaceholder]), value: this.state.value, onChange: this.handleSearchChange }),
                ...
                React.createElement("div", { className: "kendo-grid-filter-menu-container" },
                    React.createElement("form", { className: "k-filter-menu k-group k-reset k-state-border-up", onSubmit: this.submit, onReset: this.clear },
                        React.createElement("div", { className: "k-filter-menu-container" },
                            ...
                            React.createElement("div", { className: "k-action-buttons" },
                                React.createElement("button", { className: 'k-button k-primary', type: 'submit' }, localizationService.toLanguageString(messages_1.filterSubmitButton, messages_1.messages[messages_1.filterSubmitButton])),
