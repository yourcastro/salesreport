...
export declare class HeaderRow extends React.Component<HeaderRowProps, {}> {
    cellClick: (e: React.KeyboardEvent<HTMLElement> | React.MouseEvent<HTMLSpanElement, MouseEvent>, column: ColumnProps) => void;
    cellKeyDown: (event: React.KeyboardEvent<HTMLElement>, column: ColumnProps) => void;
