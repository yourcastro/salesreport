...
export declare const messages: {
    ...
    [filterAddExpression]: string;
    [filterAddGroup]: string;
    [filterClose]: string;
    [columnMenuFilterClearButton]: string;
    [columnMenuFilterSubmitButton]: string;
    [columnMenuFilterTitle]: string;
    [columnMenuSortAscending]: string;
    [columnMenuSortDescending]: string;
    [columnMenuFilterEqOperator]: string;
    [columnMenuFilterNotEqOperator]: string;
    [columnMenuFilterIsNullOperator]: string;
    [columnMenuFilterIsNotNullOperator]: string;
    [columnMenuFilterIsEmptyOperator]: string;
    [columnMenuFilterIsNotEmptyOperator]: string;
    [columnMenuFilterStartsWithOperator]: string;
    [columnMenuFilterContainsOperator]: string;
    [columnMenuFilterNotContainsOperator]: string;
    [columnMenuFilterEndsWithOperator]: string;
    [columnMenuFilterGteOperator]: string;
    [columnMenuFilterGtOperator]: string;
    [columnMenuFilterLteOperator]: string;
    [columnMenuFilterLtOperator]: string;
    [columnMenuFilterIsTrue]: string;
    [columnMenuFilterAfterOrEqualOperator]: string;
    [columnMenuFilterAfterOperator]: string;
    [columnMenuFilterBeforeOperator]: string;
    [columnMenuFilterBeforeOrEqualOperator]: string;
    [columnMenuFilterAndLogic]: string;
    [columnMenuFilterOrLogic]: string;
};
