    ...
    function Expression() {
        ...
        _this.onFieldChange = function (event) {
            ...
            if (!operators_1.unaryOperator(operator)) {
                nextFilter.value = operators_1.stringOperator(operator) ? '' : null;
            }
        ...
        return (React.createElement("div", { className: "k-filter-toolbar" },
            React.createElement(kendo_react_buttons_1.Toolbar, { keyboardNavigation: false },
                React.createElement(kendo_react_buttons_1.ToolbarItem, { className: "k-filter-field" },
                    React.createElement(kendo_react_dropdowns_1.DropDownList, { className: "k-filter-dropdown", data: fields, textField: "label", value: fields.find(function (f) { return f.name === filter.field; }), onChange: this.onFieldChange })),
