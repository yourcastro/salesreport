 ...
 * @hidden
 */
exports.FilterRow = function (props) {
    ...
    return (React.createElement("tr", { className: exports.FILTER_ROW_CLASS, "aria-rowindex": ariaRowIndex, role: 'row' }, columns.map(function (column, index) {
        ...
        return (React.createElement(HeaderThElement_1.HeaderThElement, { columnId: utils_1.getFilterColumnId(column.id), navigatable: column.navigatable, style: style, key: index, ariaColumnIndex: column.ariaColumnIndex, ariaLabel: column.filter ? intl.toLanguageString(messages_1.filterAriaLabel, messages_1.messages[messages_1.filterAriaLabel]) : undefined, className: headerCellClassName(sort, column.field, column.locked) }, column.filter && (React.createElement(column.filter, { field: column.field, filter: filter, onFilterChange: filterChange }))));
    })));
};
