(function (global, factory) {
	...
	(global.FetchHOC = factory(global.React));
...
var index = (function (resource, options) {
  return function (Component) {
    return function (_React$Component) {
      inherits(FetchHOC, _React$Component);

      function FetchHOC() {
        var _temp, _this, _ret;

        classCallCheck(this, FetchHOC);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.getUrl = function () {
          var url = resource;
